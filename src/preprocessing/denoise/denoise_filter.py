...
from src.utils.utils import ask_user_parameters
...
def denoise():
    ...
    img, _ = non_local_means_denoising(data)
...
def info_and_ask_denoising_params(filter_name, params):
    ...
    print(f"\nYou have selected {filter_name}.\n")
    print(f"Please select the filtering parameters in the pop-up window.")
